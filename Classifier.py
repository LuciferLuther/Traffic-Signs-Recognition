...
model = load_model('Traffic Sign Model.h5')

# All traffic signs classes.
...
label=Label(top,background='#CDCDCD', font=('arial',24,'bold'))
...
def show_classify_button(file_path):
    ...
    classify_b.place(relx=0.7,rely=0.85)

def upload_image():
    try:
        file_path=filedialog.askopenfilename()
        uploaded=Image.open(file_path)
        uploaded.thumbnail(((top.winfo_width()*10),(top.winfo_height()*10)))
